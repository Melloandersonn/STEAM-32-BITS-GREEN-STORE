...
function Get-SteamPath {
    Write-Host "Procurando instalacao do Steam..." -ForegroundColor Gray
...
Write-Host "Etapa 0: Localizando instalacao do Steam..." -ForegroundColor Yellow
...
if (-not (Test-Path $steamExePath)) {
    Stop-OnError "Steam.exe nao encontrado." $steamExePath "Detect Steam"
}
...
# Definindo a codificacao para UTF-8 (caso seja necessario)
...
Write-Host "=====================================================" -ForegroundColor Green
Write-Host "        Parabens, a Steam foi revertida para a versao de 32 bits com sucesso!" -ForegroundColor Green
Write-Host ""
